...
public class OVRScreenFade : MonoBehaviour
{
	...
	/// Start a fade out
	/// </summary>
	public void FadeOut(float fadeTime, SceneType _scene)
    {
        StartCoroutine(Fade(0,1, fadeTime,_scene));
    }

    /// <summary>
    /// Start a fade in
    /// </summary>
    public void FadeIn(float _fadeTime, SceneType _scene)
    {
        StartCoroutine(Fade(1, 0, _fadeTime, _scene));
    }
    ...
    /// <returns></returns>
    IEnumerator Fade(float startAlpha, float endAlpha, float _fadeTime, SceneType _scene)
    {
