...
public class LayerController{
	...
	static void ModifyFireLight(int layer_n){
		try {
			GameObject FireLights = AssetDatabase.LoadAssetAtPath("Assets/Imported Assets/LP_Fire/Prefabs/Night_Fire_Light  !!Check_Guide!!.prefab", typeof(GameObject)) as GameObject; 
			string[] paths = AssetDatabase.FindAssets("t:prefab",new string[] {"Assets/Imported Assets/LP_Fire/Prefabs"});
